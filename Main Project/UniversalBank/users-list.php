            ...
            <tr>
                ...
                <td>
                  ...
                  ?>
                    ...
                    <button type="button" style="color:green" name="active">Active</button>
                    <?php
                    }
                    else {
                  ?>
                ...
                <td>
                    ...
                    if($active == 1)
                    {
                      {
                  ?>
                    <button type="button" class="btn btn-danger" onclick="location.href='update.php?acc=<?php echo $acc; ?>&par=inactive';" name="inactive">Deactivate</button>
                    <?php
                      }
                    }
                ?>
