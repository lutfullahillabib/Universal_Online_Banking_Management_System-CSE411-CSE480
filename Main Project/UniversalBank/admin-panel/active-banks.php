    ...
    <div class="flex-container-background">
        <div class="flex-container">
            <div class="flex-item-0">
                <h1 id="form_header">Active Banks List</h1>
            </div>
        </div>
    </div>
...
?>
            <tr>
              ...
              if($active == 1)
              {
                {
            ?>
                    <button type="button" class="btn btn-danger" onclick="location.href='update.php?bank=<?php echo $bid; ?>&par=inactive';" name="inactive">Deactivate</button>
                    <?php
                }
              }
          ?>
